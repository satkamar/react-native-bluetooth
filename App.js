            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              ? (
                <View style={{ width: 48, height: 48, opacity: 0.4 }}>
                  ...
                  ? (
                    <Image style={{ resizeMode: 'contain', width: 24, height: 24, flex: 1 }} source={require('./src/images/ic_done_black_24dp.png')} />
                  ) : null}
                </View>
              ) : null}
  ...
  render () {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={{ alignSelf: 'flex-end', height: 52, backgroundColor: '#237bc1' }}>
          <ScrollView
            horizontal
